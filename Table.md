...
2. 셀 정렬
    ...
    |헤더 1|헤더 2|헤더 3|<center>헤더 4</center>|
    |:---:|:---|---:|---|
    |가운데 정렬|왼쪽 정렬|오른쪽 정렬|내용 4|
    |가운데 정렬|왼쪽 정렬|오른쪽 정렬|내용 8|
    |가운데 정렬|왼쪽 정렬|오른쪽 정렬|내용 12|
...
```md
3. 셀 크기 맞추기
    - 셀의 헤더 또는 글 공간이 부족해 자동 줄바꿈이 되어 보기 좋지 않게 되는 경우, 띄어쓰기를 삽입해 강제로 크기 조절이 가능. `&nbsp;`를 이용해 크기를 늘림
        
    + Before
    |아주아주아주아주 길고길고 긴 헤더 1|헤더 2|헤더 3|헤더 4|
    |---|---|---|---|
    |내용 1|내용 2|내용 3|내용 4|
    |내용 5|내용 6|내용 7|내용 8|
    |내용 9|내용 10|내용 11|내용 12|
